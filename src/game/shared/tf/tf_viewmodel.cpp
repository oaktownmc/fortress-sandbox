...
ConVar tf_viewmodels_offset_override( "tf_viewmodels_offset_override", "", FCVAR_CLIENTDLL, "If set, this will override the position of all viewmodels. Usage 'x y z'" );
#endif
