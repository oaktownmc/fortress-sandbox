...
#ifdef TF_CLIENT_DLL
ConVar v_viewmodel_fov( "viewmodel_fov", STR( DEFAULT_VIEWMODEL_FOV ), FCVAR_ARCHIVE, "Sets the field-of-view for the viewmodel.", true, MIN_VIEWMODEL_FOV, true, MAX_VIEWMODEL_FOV );
#else
ConVar v_viewmodel_fov( "viewmodel_fov", STR( DEFAULT_VIEWMODEL_FOV ), FCVAR_CHEAT, "Sets the field-of-view for the viewmodel.", true, MIN_VIEWMODEL_FOV, true, MAX_VIEWMODEL_FOV );
#endif
