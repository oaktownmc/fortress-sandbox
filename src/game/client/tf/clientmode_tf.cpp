...
ConVar default_fov( "default_fov", STR( DEFAULT_FOV ), FCVAR_CHEAT );
ConVar fov_desired( "fov_desired", STR( DEFAULT_FOV ), FCVAR_ARCHIVE | FCVAR_USERINFO, "Sets the base field-of-view.", true, MIN_FOV, true, MAX_FOV );
