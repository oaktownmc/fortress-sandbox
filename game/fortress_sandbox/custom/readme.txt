...
For example, you might have the following file structure:
	...
	fortress_sandbox/custom/my_custom_stuff/   <<< This subfolder will be added as a search path
	fortress_sandbox/custom/my_custom_stuff/models/custom_model.mdl
	fortress_sandbox/custom/my_custom_stuff/materials/custom_material.vmt
	fortress_sandbox/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	fortress_sandbox/custom/some_mod.vpk       <<< This VPK will be added as a search path
	fortress_sandbox/custom/another_mod.vpk    <<< This VPK will be added as a search path
...
Note that the following directory structure is NOT correct:
	...
	fortress_sandbox/custom/models/my_model.mdl

That will add the directory "fortress_sandbox/custom/models" as a search path, in which case the
file my_model.mdl actually exists at the root of the game's virtual filesystem.
Instead, you would use something like:

	fortress_sandbox/custom/my_custom_stuff/models/my_model.mdl